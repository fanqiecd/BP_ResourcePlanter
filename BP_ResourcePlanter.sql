...
-- ponytail: 核心数据固定在 LoadOrder=1000；兼容层会在更高顺序再次扫描，补登记
--          与核心数据同顺序但晚执行的第三方资源。
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
-- 第 8 步已移至 BP_ResourcePlanter_Compatibility.sql。
--          该部分会先补登记延迟加入的第三方资源，再扫描并包装其他内容的
--          Requirement，单独延后加载以减少核心数据对其他模组的全局加载顺序影响。
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
