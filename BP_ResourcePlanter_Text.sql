...
INSERT OR REPLACE INTO LocalizedText (Tag, Language, Text) VALUES
    ...
    ('LOC_BP_RESOURCE_CHOOSER_TITLE', 'en_US', 'Choose Resource'),
    ('LOC_BP_RESOURCE_CHOOSER_TITLE', 'zh_Hans_CN', '选择资源'),
    ('LOC_BP_RESOURCE_CHOOSER_PROMPT', 'en_US', 'Choose a resource to plant on this tile.'),
    ('LOC_BP_RESOURCE_CHOOSER_PROMPT', 'zh_Hans_CN', '请选择要在此格子上种植的资源。'),
    ('LOC_BP_RESOURCE_CHOOSER_ACTION_DESCRIPTION', 'en_US', 'Choose one of the valid resources for this tile and plant it.'),
    ('LOC_BP_RESOURCE_CHOOSER_ACTION_DESCRIPTION', 'zh_Hans_CN', '从当前格子可种植的资源中选择一种进行种植。'),
    ('LOC_BP_RESOURCE_CHOOSER_AVAILABLE', 'en_US', 'Available resources:'),
    ('LOC_BP_RESOURCE_CHOOSER_AVAILABLE', 'zh_Hans_CN', '当前可种植资源：'),
    -- 资源分类筛选标签(全部/加成/奢侈/战略)与空类提示。
